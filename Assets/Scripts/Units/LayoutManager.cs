...
namespace Layout
{
    ...
    public class LayoutManager : MonoBehaviour
    {
        ...
        {
            // Spawn blue hexes when 0, red when 1
            ...
            //Spawn hexagons of the designated colour and add it to the 2D array
            ...
            if (!spawningBlue)
            {
                ...
                //Spawn with ann offset depending on whether the lane is odd
                if (oddLane)
                {
